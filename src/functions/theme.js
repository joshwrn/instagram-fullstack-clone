...
const dark = () => {
  ...
  root.style.setProperty(
    '--loading-gradient',
    'linear-gradient(to right, #000000, #353535)'
  );
  root.style.setProperty(
  ...
  root.style.setProperty('--image-filter', 'invert(1) hue-rotate(180deg)');
};
...
const light = () => {
  ...
  root.style.setProperty(
    '--loading-gradient',
    'linear-gradient(to right, #ffffff, #c2c2c2)'
  );
  root.style.setProperty(
    '--messages-sidebar-background',
  ...
  root.style.setProperty('--image-filter', 'initial');
};
